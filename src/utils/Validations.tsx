...
export const validateRegisterData = (registerData: any) => {
	...
	if (!registerData.firstName || !registerData.firstName.length) {
		validateErrors.firstName = FIRST_NAME_EMPTY
		validateErrors.isError = true
	}
	if (!registerData.lastName || !registerData.lastName.length) {
		validateErrors.lastName = LAST_NAME_EMPTY
		validateErrors.isError = true
	}
	if (!registerData.email || !registerData.email.length) {
	...
	if (!registerData.password || !registerData.password.length) {
