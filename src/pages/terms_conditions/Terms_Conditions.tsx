...
const Terms_Conditions = () => {
	return (
		<div className="text-container">
			...
			<p>These Website Standard Terms and Conditions written on this webpage shall manage your use of our website, Auction accessible at www.auction.com.</p>
			...
			<p>Please read <Link to="/privacy_policy">Privacy and Policy</Link>.</p>
