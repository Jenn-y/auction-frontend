...
const Privacy_Policy = () => {
	return (
		<div className="text-container">
			...
			<p>This privacy policy (&quot;policy&quot;) will help you understand how [name] (&quot;us&quot;, &quot;we&quot;, &quot;our&quot;) uses and protects the data you provide to us when you visit and use [website] (&quot;website&quot;, &quot;service&quot;).</p>
			...
			<ul>
				...
				<li>
					<p>Data profile regarding your online behavior on our website.</p>
				</li>
			</ul>
			...
			<ul>
				...
				<li>
					<p>To send you promotional emails containing the information we think you will find</p>
					<p>interesting.</p>
				</li>
				<li>
			...
			<p>Terms and conditions template by WebsitePolicies.com</p>
